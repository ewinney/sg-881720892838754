      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  <li>
                    <Link href="/hr" className="text-base text-gray-300 hover:text-white">
                      HR
                    </Link>
                  </li>
                  <li>
                    <Link href="/payroll" className="text-base text-gray-300 hover:text-white">
                      Payroll
                    </Link>
                  </li>
                  <li>
                    <Link href="/financing" className="text-base text-gray-300 hover:text-white">
                      Financing
                    </Link>
                  </li>
                </ul>
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul className="mt-4 space-y-4">
                  <li>
                    <Link href="/calculators" className="text-base text-gray-300 hover:text-white">
                      Calculators
                    </Link>
                  </li>
                </ul>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            &copy; 2023 SmallBizHub. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
